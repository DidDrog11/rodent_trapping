...
```{r site_selection, quietly=T, fig.cap="Location of Lassa cases and infections in Sierra Leone"}
...
```{r lassa_panguma, uietly=T, fig.cap="Location of Lassa cases and infections in Eastern Sierra Leone"}
...
To address the above questions it's important to sample rodents in several distinct habitats. If these habitats undergo changed use during the observed study period this would provide some evidence for a causal association of land use change on rodent assemblage species composition. However, this is not a specific requirement for this work. Observed differences between species composition across different land usages remains illustrative of a potential association.

This land use classification is obtained from a recent paper by [@jung_global_2020] who produced a land use map of the globe classified according to the IUCN habitat classifications. The associated repository for their work is available [here](https://github.com/Martin-Jung/Habitatmapping)
