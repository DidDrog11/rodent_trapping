...
Here, we use data from a large, standardisted rodent trapping survey encompassing the Lassa fever endemic region of Eastern Sierra Leone conducted along a land use gradient to provide novel evidence on the impact of land use on the occurrence of *Mastomys natalensis* and rodent species assemblages. We first described the occurrence of rodent species at our trapping sites and describe the structure of these species assemblages. Second, we assessed the association of land use with the probability of species occupancy at trapping sites and species richness. Third, we produced species distribution maps for *Mastomys natalensis* and species with which it competes in the Lassa fever endemic zone and investigated the potential alterations to these species assemblages based on projected climate and land use changeto understand how future land use change may modify the hazard of Lassa fever outbreaks.
...
## Rodent prevalence and species assemblage structure
  ...
  * Occurrence of an individual rodent species was detected through a successful trapping event within a trapping site, assigning "1" when the species was detected and "0" otherwise. We aggregated 4 trap-nights at a trapping site into a single trapping visit. 
  * We augmented data obtained at the village level by creating all-zero detection histories of rodent species that can potentially occur in the region and were never recorded in our study. (**So these are not allocated to specific habitat types/locations?**)
  * We describe species assemblages at multiple geographic scales. First, all species identified within a single study-site. Second, all species identified within a village (i.e. an area in when rodents would be expected *a priori* to be able to diffuse across). Thirdly, all species identified within a single habitat type across multiple trapping sites and villages.
...
## Rodent species assemblages and land use
  ...
  * First, we adopted a Bayesian multi-species occupancy framework to analyse rodent trapping data. We implemented a model to estimate occupancy and species richness in each habitat type studied.
  ...
  * We estimate species richness in each habitat type by obtaining the sum of species at a trapping site for each iteration of the bayesian sampling process to compare rodent assemblage responses to anthropogenic land use change.
  * Second, we produce species distribution maps for each identified species with sufficient data using Bayesian additive regression trees
